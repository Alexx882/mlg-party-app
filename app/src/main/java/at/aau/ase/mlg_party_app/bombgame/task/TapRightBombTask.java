...
public class TapRightBombTask implements ITask {
    ...
    public void processSensorInput(IResponse response) {
        if (response instanceof TapRightResponse)
    ...
    public void execute(Context context) {
        ...
        AudioManager.instance().playSound(context, R.raw.bomb_rightbomb_to_win);
    }
}
